"""Logging utilities shared across the realtime service."""
import asyncio
import functools
import logging
...
def trace(func: Callable) -> Callable:
    ...
    Previously only supported sync wrappers, which would silently return
    a coroutine object instead of awaiting it when applied to async functions.
    """
